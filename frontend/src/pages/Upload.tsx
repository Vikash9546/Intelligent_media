          ...
          <div className="col-span-12">
            <div className="glass-card rounded-xl overflow-hidden">
              <div className="p-lg border-b border-outline-variant bg-surface-container-low flex items-center justify-between">
                ...
                {!isUploading && (
                  <button className="text-outline hover:text-error transition-colors" onClick={cancelUpload}>
              ...
              <div className="p-lg">
                {error && (
                  <div className="mb-4 p-md bg-error-container text-on-error-container rounded-lg font-body-md">
                    {error}
                  </div>
                )}
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center gap-lg">
                  ...
                  <div className="flex-grow min-w-0">
                    <div className="flex justify-between items-start mb-base">
                      ...
                      {isUploading && (
                        <span className="font-code-sm text-code-sm text-secondary font-bold">{uploadProgress}%</span>
                      )}
                    </div>
                    
                    {/* Progress Bar */}
                    {isUploading && (
                      <div className="w-full bg-surface-container h-2 rounded-full overflow-hidden mb-sm relative">
                        <div 
              ...
              {/* Footer Action */}
              {!isUploading && (
                <div className="p-lg bg-surface-container-lowest border-t border-outline-variant flex justify-end gap-md">
